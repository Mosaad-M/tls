...
def test_p384_ecdsa_verify_bad_key() raises:
    var pub = _pub_key()
...
def test_asn1_parse_ecdsa_sig_48() raises:
    var der = _sig_der()
...
def test_cert_parse_p384() raises:
    var ca_der = _ca_der()
...
def test_cert_verify_sig_p384() raises:
    var ca_der   = _ca_der()
